...
<div class="container my-4">
    <h1><?= $task['id'] ? 'Edit Task' : 'Donation From' ?></h1>
    <form method="post" novalidate>
        ...
        <div class="mb-3">
            <label for="due_date" class="form-label">Donation Date</label>
        ...
        <div class="mb-3">
            <label for="priority" class="form-label">Blood Group</label>
        ...
        <button type="submit" class="btn btn-success"><?= $task['id'] ? 'Update' : 'Add ' ?></button>
